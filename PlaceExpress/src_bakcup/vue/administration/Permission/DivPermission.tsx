        ...
        <div className="administration_contenu_permission">
            <div className="administration_contenu_permission_admin">
                ...
                <div className="administration_contenu_permission_admin_lesAdmin">
                    {lesAdmin.map(elt =>(
                        <DivAdmin mail={elt.mail} nom={elt.nom} prenom={elt.prenom} idCompte={elt.idCompte} changementAdmin={changementAdmin} key={elt.idCompte}/>
                        ))
                    }
            ...
            <div className="administration_contenu_permission_compte">
                ...
                <div className="administration_contenu_permission_compte_recherche">
                ...
                <div className="administration_contenu_permission_compte_lesResultats">
                    { lesRecherches.map(elt => (
                       <DivUnResultat estAdministrateur={elt.estAdministrateur} mail={elt.mail} nom={elt.nom} prenom={elt.prenom} idCompte={elt.idCompte} changementAdmin={changementAdmin} key={elt.idCompte}/>
                    ))}
