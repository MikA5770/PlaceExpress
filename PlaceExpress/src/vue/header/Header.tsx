    ...
    return(
        <div className="header">
            <div className="header_haut">
                ...
                <DivNavigationMobile admin={admin}   hidden={visiNavigation} pageActuel={pagesActuel}/>
                ...
                <div onClick={clickCompte} className= { pagesActuel['monCompte']? "vert header_haut_btnCompte" : "header_haut_btnCompte"}
                > 
